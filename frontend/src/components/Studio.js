  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-black/20 backdrop-blur-md pt-5 pb-3">
        ...
        {showToolSelector && (
          <div className="lg:hidden absolute top-full left-0 right-0 bg-black/90 backdrop-blur-lg border-t border-white/10 max-h-80 overflow-y-auto">
      ...
      <div className="pt-20 flex h-screen gap-0 lg:gap-4 p-2 lg:p-4">
        ...
        <div className="hidden lg:block w-80 bg-black/20 backdrop-blur-lg border border-white/10 rounded-2xl p-6 overflow-y-auto max-h-[calc(100vh-8rem)]">
