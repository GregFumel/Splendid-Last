        ...
        <div className="relative">
          ...
          <div className="relative bg-slate-900/80 backdrop-blur-lg border border-slate-700/50 rounded-2xl p-8 sm:p-10 max-w-md w-full text-center shadow-2xl">
            ...
            <div className="space-y-3 mb-8 text-left">
              ...
              <div className="flex items-center space-x-3">
                <Check className="w-4 h-4 text-green-400 flex-shrink-0" />
                <span className="text-gray-200 text-sm">AI Image Upscaler Pro - Meilleur upscaler</span>
              </div>
              <div className="flex items-center space-x-3">
                <Check className="w-4 h-4 text-green-400 flex-shrink-0" />
                <span className="text-gray-200 text-sm">UGC Creator AI - Vidéos de vente authentiques</span>
              </div>
              <div className="flex items-center space-x-3">
                <Check className="w-4 h-4 text-green-400 flex-shrink-0" />
