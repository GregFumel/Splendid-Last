            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 md:gap-6 mb-4 sm:mb-6 pt-8 sm:pt-6">
                ...
                <div className="bg-gray-800/50 rounded-xl sm:rounded-2xl p-2 sm:p-4 md:p-6 flex flex-col items-center relative shadow-lg shadow-green-500/20 hover:shadow-green-500/40 transition-all overflow-hidden">
                  ...
                  <div className="absolute -top-8 sm:-top-6 left-1/2 transform -translate-x-1/2 bg-gradient-to-br from-green-500 to-green-600 text-white text-[10px] sm:text-xs font-bold px-2 sm:px-3 md:px-4 py-1 rounded-full border border-white/30 shadow-lg z-20 whitespace-nowrap" style={{
                ...
                <div className="bg-gray-800/50 rounded-xl sm:rounded-2xl p-2 sm:p-4 md:p-6 flex flex-col items-center relative shadow-lg shadow-yellow-500/20 hover:shadow-yellow-500/40 transition-all overflow-hidden">
                  ...
                  <div className="absolute -top-5 sm:-top-4 left-1/2 transform -translate-x-1/2 bg-gradient-to-br from-yellow-500 to-yellow-600 text-white text-[10px] sm:text-xs font-bold px-2 sm:px-3 md:px-4 py-1 rounded-full border border-white/30 shadow-lg whitespace-nowrap z-10" style={{
